# UniBlood Reference Creation

### Overview

This readme documents the creation process of the UniBlood sorted cell
DNAme references used in the CellsPickMe R package. The package
...
Illumina methylation arrays (compatible with HM450k, EPICv1, and EPICv2)
...
The UniBlood references, including UniBlood7, UniBlood13, and
UniBlood19, were generated based on combining preexisting cord blood and
adult blood-based references. By combining sorted cells’ DNAme from
...
**Table 1**. Cellular composition and dataset included for the three
reference datasets we compiled in this study, UniBlood7, UniBlood13, and
UniBlood19.
...
UniBlood7 includes the Reinius, Cord, and IDOL references. With only 7
cell types, the reference treat neonatal and adult cells of the same
identity (e.g. CD4T cells) as one cell type.
...
UniBlood13 is mostly built on the Extended reference, with additional
...
Finally, UniBlood19 is the reference with the most cell types. It
...
blood cells labelled with the “\_cord” suffix.
