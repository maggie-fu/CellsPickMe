...
head(probes$coefs$probeList$Bcell$EN)
```
...
```{r visualization, warnings = FALSE, message = FALSE}
# Estimated proportions based on IDOL reference, Noob normalization, lasso / EN feature selection, and constraint projection
...
plt <- out$EN[, c("CD8T", "CD4T", "NK", "Bcell", "Mono", "Gran")] %>%
    as.data.frame(.) %>% 
    reshape2::melt()
